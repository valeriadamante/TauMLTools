...
class EffRate:
    ...
    def efficiency_calculator(self, last_module_name):
        ...
        for file in self.input_files:
          ...
          print("saving denominator with two had taus without correspondence ")
          df_den = df
    ...
    def save_numbers(self, last_module_name, type):
        import json
        # save to npy file
        full_name = ("{}_noCorr/efficiency_NumAndDen_{}_{}_{}.json").format(self.sample,type, last_module_name, self.sample)
        dict = {}
        for pt1_index in range(0, len(self.Pt1Bins)-1):
    ...
    def fill_histogram(self, type, last_module_name,add1Dplot=False):
        ...
        #canvas.SetLogy()
        #canvas.Update()
        rootFileName= ("{}_noCorr/efficiency_{}_{}_{}.root").format(self.sample, type, last_module_name, self.sample)
