...
void NewTuple::GetWeight(std::string dataFileName, std::string dataTupleName="L2TauTrainTuple"){
  ...
  c1.SaveAs("final_plots/SignalHist.pdf");
  ...
  QCDHist.Draw("HIST");
  c2.SaveAs("final_plots/QCDHist.pdf");
  // 3. data histogram
  ...
  DataHist.Draw("HIST");
  c3.SaveAs("final_plots/DataHist.pdf");
  ...
  legend->Draw("SAME");
  c3_1.SaveAs("final_plots/QCDDataHistBefore.pdf");
  ...
  c4.SaveAs("final_plots/WeightedSignalHist.pdf");
  ...
  c5.SaveAs("final_plots/WeightedQCDHist.pdf");
  ...
  legend2->Draw("SAME");
  c6.SaveAs("final_plots/WeightedBckgHist.pdf");
